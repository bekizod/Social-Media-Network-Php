...
<style>
    ...
    <div class="setting_main">
        ...
        <center><i class="fa fa-cog" aria-hidden="true"></i><b> Settings </b></center> <hr style="margin-left: auto; width: 70%; margin-bottom: 20px;">
            ...
            <div >
                ...
                <form action="account_settings.php" method="post"  enctype="multipart/form-data">
                    <tr class="r1">
                        ...
                        <td class="covet_img"> <span><h4>Chang Cover Pic :<h4> <input type="file" name="cover_pic" id="cover"> <input type="submit" name="submit_cover_pic" value="Sublit"> <input type="submit" style="background: red;" value="Cancel"></span> </td>
                    </tr>
                    <tr><td><hr style="width: 240%;"></td></tr>
                    <tr class="r2">
                        <td class="imgs2" >  <img src='<?php echo $user_array['profile_pic']; ?>' style="height: 100px; width: 100px;">  </td>
                        <td >  <span style="margin-top: 0px; margin-left: 182px;"> <h4>Chang Profile Pic :<h4> <input type="file" name="profile_pic" id="profile"><input type="submit" name="submit_profile_pic" value="Sublit"> <input type="submit" style="background: red;" value="Cancel"></span>  </td>
                    </tr>
                    <tr><td><hr style="width: 240%;"></td></tr>
                    <tr class="r4">
