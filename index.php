...
<style>
    ...
    <div class="info-box" style="background:black; margin-left: 80px;">
        <div class="info-inner">
            ...
            <div class="info-in-body">
                ...
                <div class="info-body-name">
                    <div class="in-b-name">
                        <div style="color: antiquewhite;"><a href="<?php echo $userLoggedIn; ?>"><?php echo $user['first_name'] . " " . $user['last_name']; ?></a>
                        </div>
